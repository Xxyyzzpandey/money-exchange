...
export default function HistoryCard(){
  ...
  <h2 className="text-2xl mb-4">Transitions History</h2>
      ...
      <table className="min-w-full bg-white border mb-20">
        <thead>
          <tr className="bg-[#2B4DC994] text-center text-xs md:text-sm font-thin text-white">
            ...
            <th className="p-0">
              <span className="block py-2 px-3 border-r border-gray-300">To</span>
            </th>
            <th className="p-0">
              <span className="block py-2 px-3 border-r border-gray-300">Date</span>
            </th>
            <th className="p-4 text-xs md:text-sm">Status</th>
          </tr>
        </thead>
        <tbody>
